//
//  MaltsTableTableViewController.swift
//  HopHead
//
...
class MaltsTableTableViewController: UITableViewController {

    @IBOutlet var maltView: UITableView!
    ...
    //Example color gradient: maltsAccent1Color, maltsAccent2Color, maltsColor, maltsAccent4Color
    ...
    var abvs = [Int]()
    var ibus = [Int]()
    var colors = [UIColor(red: 171, green: 41, blue: 26), UIColor(red: 234, green: 91, blue: 80),UIColor(red: 211, green: 54, blue: 42), UIColor(red: 142, green: 23, blue: 14) ]

    var favorties = [Int] ()
    
    //let cellReuseIdentifier = "MaltsTableViewCell"
    ...
    override func viewDidLoad() {
        ...
        if sqlite3_bind_text(statement, 1, "Malts", -1, SQLITE_TRANSIENT) != SQLITE_OK {
            let errmsg = String(cString: sqlite3_errmsg(db))
            print("failure binding Malts cat: \(errmsg)")
        }
    ...
    */
       ...
       override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            //var cell = UITableViewCell() as! MaltsTableViewCell
             let cell = tableView.dequeueReusableCell(withIdentifier: "MaltsTableViewCell", for: indexPath) as! MaltsTableViewCell
