//
//  LagersTableTableViewController.swift
//  HopHead
//
...
class LagersTableTableViewController: UITableViewController {
    ...
    @IBOutlet var lagersView: UITableView!
    ...
    //Example color gradient: lagersAccent1Color, lagersAccent2Color, lagersColor, lagersAccent4Color
    ...
    var abvs = [Int]()
    var ibus = [Int]()
    var colors = [UIColor(red: 241, green: 149, blue: 40), UIColor(red: 237, green: 178, blue: 108),UIColor(red: 239, green: 164, blue: 82), UIColor(red: 214, green: 128, blue: 33) ]

    var favorties = [Int] ()
    
    //let cellReuseIdentifier = "LagerTableViewCell"
    ...
    override func viewDidLoad() {
        ...
        if sqlite3_bind_text(statement, 1, "Lagers", -1, SQLITE_TRANSIENT) != SQLITE_OK {
            let errmsg = String(cString: sqlite3_errmsg(db))
            print("failure binding Lagers cat: \(errmsg)")
        }
    ...
    */
       ...
       override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            //var cell = UITableViewCell() as! lagerTableViewCell
             let cell = tableView.dequeueReusableCell(withIdentifier: "lagerTableViewCell", for: indexPath) as! lagerTableViewCell
